# Review packet — fog-signal-check (qa)

Everything a reviewer needs to judge this roll, and nothing they have to go
looking for. Generated by `node engine/claude_agent.mjs qa --roll fog-signal-check --packet`.
...
Write your answer as `verdict.json` next to this file, then apply it:
    ...
    node engine/claude_agent.mjs qa --roll fog-signal-check --apply workspace/fog-signal-check/_review/qa/verdict.json
