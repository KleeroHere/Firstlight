# Review packet — handover-at-the-pier (qa)

Everything a reviewer needs to judge this roll, and nothing they have to go
looking for. Generated by `node engine/claude_agent.mjs qa --roll handover-at-the-pier --packet`.
...
| `sheets/` | A 12-frame contact sheet per clip — the frames to judge. |
...
Write your answer as `verdict.json` next to this file, then apply it:
    ...
    node engine/claude_agent.mjs qa --roll handover-at-the-pier --apply workspace/handover-at-the-pier/_review/qa/verdict.json
