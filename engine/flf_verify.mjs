...
// Порог откалиброван по замерам на реальных планах: статичный кивок
// (совпали граничные ключи) дал 0.61, а живой план с мелким жестом одного
// человека в общем плане на четверых — 0.94. Порог 0.8 разделяет эти два
// случая: мелкий жест проходит, настоящая статика ловится.
