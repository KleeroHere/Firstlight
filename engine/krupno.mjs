...
//     --id razbor-dnevnikov --scene s1 --char yaroslav --shot 2 \
//     --beat "правая ладонь прижата к груди, он говорит" --emotion "пояснение"
//
// Зачем (31.08.2026). Длительность сцены задаёт озвучка, а клип FLF2V — это
// ровно 5 секунд. Где планов не хватило, сборщик держал последний кадр: по
// всей серии набралось 115 таких дыр, до 10 секунд стоп-кадра в сцене.
// Владелец предложил закрывать их крупными планами: Gemini почти не
// ошибается, когда в кадре один человек, и на каждого есть лист
// «диалоговые выражения лица» — восемь портретов крупно.
//
