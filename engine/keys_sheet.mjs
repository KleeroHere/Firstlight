...
//
//   node engine/keys_sheet.mjs --id razbor-dnevnikov
//
...
// после часов на поде. Приёмка 29.08.2026 показала, что половина замечаний
// владельца («олимпийки вернулись», «доска снова полная», «Гарик снова у
// камеры») видна прямо на паре старт-финиш, до всякой генерации видео.
//
